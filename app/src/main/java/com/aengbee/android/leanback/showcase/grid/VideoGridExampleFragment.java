...
package com.aengbee.android.leanback.showcase.grid;
...
import com.aengbee.android.leanback.model.VideoCard;
import com.aengbee.android.leanback.model.VideoRow;
 ...
 * It fetches the videos from the the url in {@link } and displays the metadata
 * fetched from each video in an ImageCardView (using {@link }).
...
public class VideoGridExampleFragment extends VerticalGridFragment implements
    ...
    private void onFetchVideosInfoError(Exception ex) {
        ...
        Toast.makeText(getActivity(), "Error fetching videos from json file",
