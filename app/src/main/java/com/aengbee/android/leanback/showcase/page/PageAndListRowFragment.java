...
package com.aengbee.android.leanback.showcase.page;
...
import com.aengbee.android.leanback.card.presenters.SettingsIconPresenter;
...
public class PageAndListRowFragment extends BrowseFragment {
    ...
    private static final String HEADER_NAME_5 = "Webview1";
    ...
    public static class WebViewFragment extends Fragment implements MainFragmentAdapterProvider {
        ...
        public View onCreateView(
            ...
            mWebview.loadUrl("http://fytoz.asuscomm.com/4TB/TJ/48/48288.html");
    ...
    public static class WebViewFragment2 extends Fragment implements MainFragmentAdapterProvider {
        private MainFragmentAdapter mMainFragmentAdapter = new MainFragmentAdapter(this);
        private WebView mWebview;
        ...
        public void onResume() {
            super.onResume();
            mWebview.loadUrl("http://www.torrentwiz3.com");
            getMainFragmentAdapter().getFragmentHost().notifyDataReady(getMainFragmentAdapter());
        }
    }
}
