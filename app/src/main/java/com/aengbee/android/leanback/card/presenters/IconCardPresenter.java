...
package com.aengbee.android.leanback.card.presenters;
...
public class IconCardPresenter extends ImageCardViewPresenter {
    ...
    protected ImageCardView onCreateView() {
        ...
        image.getBackground().setAlpha(255);
    ...
    public void onBindViewHolder(Card card, final ImageCardView cardView) {
        ...
        if (card.getLocalImageResourceName().length() != 1) {
            ...
            cardView.getMainImageView().setImageDrawable(TextDrawable.builder()
                    .beginConfig()
                    .textColor(Color.parseColor("#F7F7F7"))
                    .fontSize(30) /* size in px */
                    .bold()
                    .endConfig()
                    .buildRound(card.getLocalImageResourceName(), Color.TRANSPARENT));
