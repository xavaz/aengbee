...
import com.aengbee.android.leanback.data.VideoDbBuilder;
import com.aengbee.android.leanback.data.VideoDbHelper;
import com.aengbee.android.leanback.ui.MainActivity;
...
public class VideoDbIntegrationTest extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    public void resetAndInsertLocalVideos() throws JSONException {
        ...
        List<ContentValues> contentValuesList = videoDbBuilder.buildMedia(myMedia,0);
